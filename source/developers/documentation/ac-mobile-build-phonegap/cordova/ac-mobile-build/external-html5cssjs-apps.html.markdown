...
Once your project is uploaded, you will see the following screen. You are then ready to [add your certificates](/developers/documentation/ac-mobile-build-phonegap/cordova/certificates/) and then [build](/developers/documentation/ac-mobile-build-phonegap/cordova/ac-mobile-build/automatic-building) your App.
