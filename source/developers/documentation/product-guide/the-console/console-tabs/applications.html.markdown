...
<td>
  Choose to build your apps using [AC Mobile Build](/developers/documentation/ac-mobile-build-phonegap/cordova/ac-mobile-build/) or <a href="/developers/documentation/ac-mobile-build-phonegap/cordova/phonegapbuild/">Phonegap:Build</a> . If you wish to compile as a Native App for mobile devices you can do so here.

If you are planning to build Native Apps, then you must read the [Phonegap & Native Apps](/developers/documentation/ac-mobile-build-phonegap/cordova/) chapter, which describes how this can be achieved.
