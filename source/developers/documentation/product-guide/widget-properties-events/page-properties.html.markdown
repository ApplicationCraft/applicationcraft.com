...
<td width="765">
  If you want your GA tracking to be javascript free, then you can set the 'Google Analytics Track Code' property for any page you like within your App. See <a href="/developers/documentation/product-guide/advanced-features/google-analytics/page-based-tracking-code">Page Based Tracking Code</a>
...
<td width="765">
  Where you can change the width of the page relative to the size of the browser. Used in 'Relative Mode'. See <a href="/developers/documentation/product-guide/content-and-app-layout/responsive-adaptive-fluid-design/absolute-and-relative-layout">Absolute and Relative Layout</a>
...
<td width="765">
  Auto/Pre Rendering/Post Rendering. Properties to help manage <a href="/developers/documentation/product-guide/mobile-apps-sites/page-transition-effects">Page Transitions</a> and show an hourglass.
...
Post Rendering - The target page will be loaded and while the content is rendered an hourglass will be shown. See: [Transition Mode](/developers/documentation/product-guide/mobile-apps-sites/mobile-transition-mode)
...
<td width="765">
  This is empty by default, which indicates that the Page's back color is taken from the App's <a href="/developers/documentation/product-guide/the-console/console-tabs/themes-overview">Theme</a> . It can be reset the to Theme's Page Back Color by pressing "Use Theme" in the property's pop-up dialog.
...
<td width="765">
  Used to specify the margin/padding around a widget when the parent container is in Relative Mode. See <a href="/developers/documentation/product-guide/content-and-app-layout/introduction/setting-a-margin">Setting a Margin</a>
...
<td width="765">
  This indicates whether you wish to see and use a snap to grid mechanism that allows Widgets to snap precisely into place. You may not need to use the Snap to Grid as AC supports a very nice <a href="/developers/documentation/product-guide/content-and-app-layout/editing-and-laying-out-reference/widget-alignment-distribution">Drag Alignment</a> feature.
