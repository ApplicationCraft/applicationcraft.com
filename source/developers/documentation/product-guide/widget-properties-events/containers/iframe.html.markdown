...
iFrame Widget creates an inline frame that displays a webpage from a URL. The webpage is set through the URL property of the iFrame Widget.
...
<td width="779">
Internal class name of the widget.- WiziCore\_UI\_IFrameWidget
...
<td width="779">
iframe/div. Select the mode. iframe for normal iframe mode, div for an 'in-place' mode where the content is shown without iFrame
