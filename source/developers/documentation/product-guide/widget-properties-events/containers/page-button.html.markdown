...
The Page Button works with the [Repeating Container](/developers/documentation/product-guide/widget-properties-events/containers/repeater) , [Listbox](/developers/documentation/product-guide/widget-properties-events/common/listbox) , [Dropdown List](/developers/documentation/product-guide/widget-properties-events/common/dropdown-list) , [Grid](/developers/documentation/product-guide/widget-properties-events/advanced/grid) , [Mobile Checkbox](/developers/documentation/product-guide/widget-properties-events/mobile/mobcheckbox) , [Mobile Popup Listbox](/developers/documentation/product-guide/widget-properties-events/mobile/popup-listbox) , [Mobile Popup Dropdown](/developers/documentation/product-guide/widget-properties-events/mobile/popup-dropdown) and [Mobile List](/developers/documentation/product-guide/widget-properties-events/mobile/list) and allows the User to view more data entries. At the time of writing the button only allows you to move on to the next page but we will soon enable homepage and previous page functions.
