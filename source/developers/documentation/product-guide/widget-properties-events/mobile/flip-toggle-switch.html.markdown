---
old_url: flip_toggle_switch.htm
title: "Flip Toggle Switch"
...
Allows users to toggle On/Off. You can then interact with this change if required using [Scripting with Javascript](/developers/documentation/scripting-apis/client-scripting-overview/scripting-with-javascript/)
...
<td width="779">
Internal class name of the widget.- WiziCore\_UI\_FlipToggleSwitchMobileWidget
...
<td width="779">
true/false. Select to show default state. true = On, false = Off
...
<td width="779">
Where you can customise the text of the 'On' label
...
<td width="779">
Where you can customise the text of the 'Off' label
...
## See Also
 ...
 - Mobile Widgets: [Radio Buttons Group](/developers/documentation/product-guide/widget-properties-events/mobile/radiobuttonsgroup)
