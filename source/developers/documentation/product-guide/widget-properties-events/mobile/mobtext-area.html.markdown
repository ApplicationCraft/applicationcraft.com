...
<td width="779">
Internal class name of the widget.- WiziCore\_UI\_TextAreaMobileWidget
...
<td width="779">
Displays the number of words used.
...
## See Also
 ...
 - Common Widgets: [Text Area](/developers/documentation/product-guide/widget-properties-events/common/text-area) , [Text](/developers/documentation/product-guide/widget-properties-events/common/text)
