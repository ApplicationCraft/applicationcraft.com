...
Search is to allow you to search for data and return the results to other Widgets that are [Listening](/developers/documentation/product-guide/advanced-features/data-integration-reporting-dashboards/data-section-properties/listen)
...
<td width="779">
Internal class name of the widget.- SearchMobile
...
## See Also
 ...
 - [Search](/developers/documentation/product-guide/widget-properties-events/advanced/search) (Advanced)
