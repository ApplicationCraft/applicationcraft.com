...
<td width="779">
  This is where you can prefill your list. You can also populate your list by code. See <a href="/developers/documentation/scripting-apis/client-api/widget-data-state-manipulation/populatewidget/mobiscroll-list2">Mobiscroll List</a>
