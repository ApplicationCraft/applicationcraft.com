...
This control is used for text data entry over multiple lines. It is also capable of character and word counting, can be set to contain a maximum number of characters and also display the number of characters left before the limit is reached. These are set in the behavior properties for the Text Area by setting the property to display in either a Label or Number Widget.
...
<td width="779">
Displays the number of characters left if Max Chars property is defined.
...
<td width="779">
Displays the number of words used into another field
...
## See Also
 ...
 - Common Widgets: [Text](/developers/documentation/product-guide/widget-properties-events/common/text) , [Alpha Numeric](/developers/documentation/product-guide/widget-properties-events/common/alpha-numeric) , [Numeric](/developers/documentation/product-guide/widget-properties-events/common/numeric)

 - Advanced Widgets: [Mask Edit](/developers/documentation/product-guide/widget-properties-events/advanced/mask-edit)

 - Mobile Widgets: [Text Area](/developers/documentation/product-guide/widget-properties-events/mobile/mobtext-area) , [Text](/developers/documentation/product-guide/widget-properties-events/mobile/mobtext)
