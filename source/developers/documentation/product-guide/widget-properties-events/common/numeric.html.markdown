...
This allows entry of numeric data with basic format control. If you need to enter data in a specific way, you can use a [Mask Edit](/developers/documentation/product-guide/widget-properties-events/advanced/mask-edit) control. Alternatively, you could use a "Regular Expression" in Application Craft Javascript to achieve complex data format validations post entry.
...
<td width="779">
The default number is set with this property.
...
<td width="779">
This is where you can define the format of the numeric field
...
<td width="779">
Align your number Left/Right or Center
...
## See Also
 ...
 - Common Widgets: [Text Area](/developers/documentation/product-guide/widget-properties-events/common/text-area) , [Text](/developers/documentation/product-guide/widget-properties-events/common/text) , [Alpha Numeric](/developers/documentation/product-guide/widget-properties-events/common/alpha-numeric)

 - Advanced Widgets: [Mask Edit](/developers/documentation/product-guide/widget-properties-events/advanced/mask-edit)

 - Mobile Widgets: [Text](/developers/documentation/product-guide/widget-properties-events/mobile/mobtext) , [Text Area](/developers/documentation/product-guide/widget-properties-events/mobile/mobtext-area)
