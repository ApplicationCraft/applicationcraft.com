...
The Color picker allows your users to select a color and use this to apply to other widgets in your app.

With the OnChange event, you can apply this color to multiple widgets using [setProperty()](/developers/documentation/scripting-apis/client-api/widget-functions/setproperty)
...
<td width="779">
Internal class name of the widget.- WiziCore\_UI\_ColorPickerWidget
...
<td width="779">
This is the default color of the Widget
...
<td width="779">
Use this to select other widget to apply font color to from selection made in this Color picker
...
<td width="779">
Use this to select other widget to apply background color to from selection made in this Color picker
...
<td width="779">
Use this to select other widget to apply border color to from selection made in this Color picker
