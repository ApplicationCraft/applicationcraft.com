...
The Rich Text widget allows you to present a Rich Text Editor to your app users. Please note this widget is not supported for Mobile Devices and may not function on all mobile platforms
...
<td width="779">
This allows users to be able to access the full controls of the Editor
...
<td width="779">
Simple(default)/Full. Set to Full to present full editor options or Simple for a standard set of options
...
<td width="779">
Enter any default text you wish to present
...
<td width="779">
Define the color of linked content in the widget.
