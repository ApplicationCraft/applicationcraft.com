...
The Mask Edit control is used to control the way that data is entered into a single line field. By setting an Input Mask within the Mask property, each character of input is validated as it is typed.
...
<td width="779">
Internal class name of the widget.- WiziCore\_UI\_MaskEditWidget
