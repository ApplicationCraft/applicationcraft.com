...
<td width="779">
Internal class name of the widget.- WiziCore_UI_FileUploadWidget
...
<td width="779">
This is where you can change the display options
...
<td width="779">
This is where you can change the text for the Attach file button
...
<td width="779">
This is where you can change the text for the Detach file button
...
<td width="779">
This is where you can change the text for the Stop button (ie if users want to stop their upload)
...
<td width="779">
This is where you can change where the Buttons show in the File Upload Widget
...
<td width="779">
This is where you can restrict uploads to specific file types.  &lt;blank&gt; = any file type. For multiple file types separate with | eg: jpg|png
...
<td width="779">
The background color of the button in the Widget. If it is empty, the App's Theme Back Color will be used. If you override this and want to revert to the Theme Style Back Color, then open up the property dialog and select the "Use Theme" option.
...
<td width="779">
Specified the line width of the border surrounding the button in the Widget. If you override this and want to revert to the Theme Style Back Color, then open up the property dialog and select the "Use Theme" option
...
<td width="779">
Specify the radius of the border for the button in the widget
...
<td width="779">
Specify the font of the Button
