...
<td width="782">
The URL of the page to show in the dialog. By default this will be populated with the Short URL. If you are defining a Custom URL ID you can change to use that if required
