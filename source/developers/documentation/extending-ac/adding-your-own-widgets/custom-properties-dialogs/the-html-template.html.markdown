...
To see how this gets populated by our property value, refer to [EXP 4 : the dialog code](/developers/documentation/extending-ac/adding-your-own-widgets/custom-properties-dialogs/exp-4-the-dialog-code) .
