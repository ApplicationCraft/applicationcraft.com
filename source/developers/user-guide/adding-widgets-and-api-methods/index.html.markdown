...
If you are looking for information on how to write scripts within your Application Craft Apps, please go to the [Scripting & APIs](/developers/user-guide/scripting-apis/) section in the User Guide.
