...
Performs an AJAX call and returns more comprehensive content than [httpRequest()](httprequest2.htm) . Please refer to [httpRequest()](../../../client-api/soap-restful-ajax-calls/httprequest) in the client API for full documentation.
