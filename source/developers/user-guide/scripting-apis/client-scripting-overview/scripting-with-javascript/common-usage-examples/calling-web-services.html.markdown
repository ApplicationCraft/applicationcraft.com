...
This chapter shows all of these approaches being used. If you want to know how to build AC system extensions, then [Extending Application Craft](../../../../adding-widgets-and-api-methods/index.htm) and [Widget Extensions](../../../../adding-widgets-and-api-methods/adding-your-own-widgets-to-application-craft/index.htm) are described within the Developer Guides.

## See Also

[Extending Application Craft](../../../../adding-widgets-and-api-methods/index.htm)

[Widget Extensions](../../../../adding-widgets-and-api-methods/adding-your-own-widgets-to-application-craft/index.htm)
