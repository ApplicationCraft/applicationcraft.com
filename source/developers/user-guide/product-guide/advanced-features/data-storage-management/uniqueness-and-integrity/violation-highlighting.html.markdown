...
These properties are also used by [checkMandatory()](../../../../scripting-apis/client-api/widget-functions/checkmandatory.htm) and [highlightWidgets()](../../../../scripting-apis/client-api/widget-functions/highlightwidgets.htm) functions if their optional parameters are omitted.
