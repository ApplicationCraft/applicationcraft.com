...
Application Craft can communicate very easily with Web Services, whether RESTful or SOAP and so tying your AC App to the back-end will be simple.  See: [SOAP & RESTful AJAX Calls](../../../scripting-apis/client-api/soap-restful-ajax-calls/index.htm)
