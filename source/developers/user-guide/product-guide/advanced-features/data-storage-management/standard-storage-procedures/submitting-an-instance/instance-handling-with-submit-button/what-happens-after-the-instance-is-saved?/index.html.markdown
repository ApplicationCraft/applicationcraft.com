...
Once the Instance has been successfully saved, the App will not change appearance, by default. However, there are several things you can do in the [Application Properties](../../../../../../../widget-properties-events/app-properties.htm#advanced) to modify the behavior upon successful submission.
...
## See Also:
 ...
 - [Page Functions](../../../../../../../scripting-apis/client-api/page-functions/index.htm)
