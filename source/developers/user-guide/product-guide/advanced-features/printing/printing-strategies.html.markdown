...
Another thing you will consider is what to do while you wait for the printing to happen. These are possible things you can do
 ...
 - Show the Twirly Thing before the [printApp()](../../../scripting-apis/client-api/app-functions/printapp.htm) call and hide it from the callback function
...
For code examples, please go to the [Printing Examples](printing_examples.htm) topic.
