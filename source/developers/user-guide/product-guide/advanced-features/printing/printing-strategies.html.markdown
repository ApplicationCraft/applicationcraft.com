...
Another thing you will consider is what to do while you wait for the printing to happen. These are possible things you can do
 ...
 - Show the Twirly Thing before the [printApp()](/developers/user-guide/scripting-apis/client-api/app-functions/printapp) call and hide it from the callback function
