...
You can then call [app.cookie()](/developers/user-guide/scripting-apis/client-api/others/cookie) to read data from your cookie and load it into your array, object or variable.
