...
<td width="720">
contains all the available [Widgets](../../../widget-properties-events/index) that can be used in a AC App.
...
<td width="712">
Displays all available Properties for the selected Widget. See [Widget Properties](../../../widget-properties-events/index) for more information.
...
<td width="712">
Displays all available Event actions for the selected Widget. See [Event Handling](../../../widget-properties-events/events/index) for more information.
