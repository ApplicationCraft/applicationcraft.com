...
<td width="754">
  A dialog that allows you to specify Google Map Libraries to use. See <a href="/developers/user-guide/product-guide/advanced-important-widgets/google-v3-maps-widget/advanced-accessing-the-googl">Accessing the Google Object</a>
