...
<td width="782">
  This is where you can prefill your list/dropdown widgets either manually or by importing a CSV list stored as a resource. See <a href="/developers/user-guide/product-guide/widget-properties-events/prefill">Prefill</a> . The top entry is where you can enter text to show in the main item
