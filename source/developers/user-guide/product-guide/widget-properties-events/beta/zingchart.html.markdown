...
Zingchart can be configured to show different chart types and optimised for Mobile apps. See [Zing Charts](/developers/user-guide/product-guide/advanced-important-widgets/zing-charts/) for more information
