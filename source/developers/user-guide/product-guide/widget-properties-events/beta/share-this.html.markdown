...
<td width="782">
  The URL of the app to show within the widget. By default it is set to the Short URL of the app you are working in, but you can enter in another format of the App URL if you require. See <a href="/developers/user-guide/product-guide/the-console/console-tabs/applications">Apps</a>
