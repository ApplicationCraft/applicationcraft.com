...
<td width="747">
It is called once whenever the App resizing triggers an Adaptive Layout rule. See [Adaptive Layout Event](../../../content-and-app-layout/responsive-/-adaptive-/-fluid-design/adaptive-layout-event) .
...
<td width="747">
This is called just before the actual Instance submission takes place. It allows you to perform checks and cancel the submission process if you need to as described in [On Pre Submit](../../../advanced-features/data-storage-management/standard-storage-procedures/submitting-an-instance/instance-handling-with-submit-button/what-happens-after-the-instance-is-saved?/using-application-craft-events/on-pre-submit) .
...
<td width="747">
Called whenever the browser resizes. See [Resize Events](../../../content-and-app-layout/responsive-/-adaptive-/-fluid-design/resize-events) .
...
<td width="747">
Called whenever the browser resizes but is called on an App resize whenever a specific page is already shown. Allows the user to write page specific handling. See [Resize Events](../../../content-and-app-layout/responsive-/-adaptive-/-fluid-design/resize-events) .
...
## **See Also**
 ...
 - [Google V3 Map Events](../../../advanced-important-widgets/google-v3-maps-widget/property,-event,-method-summary/gmapevents)

 - [Video and Audio Widget Events](../../../advanced-important-widgets/video-audio-widgets/property,-methods,-event-summary/videvents)
