...
<td width="740">
Set the icon to use in your App when compiling as a Mobile Native App. See [Icon Management](../mobile-apps-sites/icon-management)
...
<td width="740">
Points to an image that is used as a splash screen when the App loads. See [Splash Image Management](../mobile-apps-sites/splash-image-management)
...
<td width="740">
This is where you can set the default app page transition properties See [Page Transition Effects](../mobile-apps-sites/page-transition-effects)
...
<td width="740">
The login form to be used for this app See [Using one Login App for all Apps](../advanced-features/authentication-for-your-apps/typical-authentication-strategies/using-on-login-app-for-all-app)
...
<td width="740">
Set User access levels to your app. See [Sharing](../the-console/sharing)
...
<td width="740">
Where you can add languages to your app. See [Adding One or More Languages](../advanced-features/multi-language-apps/adding-one-or-more-languages)
...
<td width="740">
Where you can set your Language Tokens and also import/export a CSV file to work with externally. See [Language Tokens](../advanced-features/multi-language-apps/tokens)
...
<td width="740">
This defines where to go in the current App after the Instance is submitted. See also [What happens after the instance is saved](../advanced-features/data-storage-management/standard-storage-procedures/submitting-an-instance/instance-handling-with-submit-button/what-happens-after-the-instance-is-saved?/) .
...
<td width="740">
This defines which URL to go to after the instance is submitted. See also [What happens after the instance is saved](../advanced-features/data-storage-management/standard-storage-procedures/submitting-an-instance/instance-handling-with-submit-button/what-happens-after-the-instance-is-saved?/) .
...
<td width="740">
Where you can define a specific Google Analytics Account ID overriding your account default. See [Google Analytics ID Override Property](../advanced-features/google-analytics/google-analytics-id-override-p)
...
<td width="740">
Where you can set a specific API key for [Google Maps Advanced](advanced/google-maps-advanced) overriding the [Google Maps](../the-console/console-tabs/more/account-variables/google-maps) account key
...
<td width="740">
This is the name of the Instance when it is saved so you can access it through a Query. See also [How to Report on App Data](../advanced-features/data-storage-management/how-to-report-on-app-data/) .
...
<td width="740">
Through this dialog you can pair Apps together through any form of relationship; One to One, One to Many and Many to Many. See also [App Instances](../advanced-features/data-storage-management/dataapp-instances) .
...
<td width="740">
This is the [Theme](../content-and-app-layout/introduction/themes-styles/themesmanage) that the App uses. Widgets within the App will take their default Style settings from this Theme.
