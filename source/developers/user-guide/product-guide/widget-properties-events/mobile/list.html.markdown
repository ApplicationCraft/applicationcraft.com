...
See: [Mobile List Widget](../../advanced-important-widgets/important-mobile-widgets/mobile-list-widget/)
...
<td width="779">
This is where you can prefill your list/dropdown widgets either manually or by importing a CSV list stored as a resource. See [Prefill](../prefill) .  You can also set 'Page Jump' actions to automatically re direct users to other pages in your app, and set Dividers. See [Mobile List Widget](../../advanced-important-widgets/important-mobile-widgets/mobile-list-widget/)
