...
<td width="779">
Select the [Password](/developers/user-guide/product-guide/widget-properties-events/authentication/authpassword) widget.
...
<td width="779">
This accesses a [Captcha](/developers/user-guide/product-guide/widget-properties-events/authentication/authcaptcha) Widget, to prevent computer automatic access. Used when widget is defined as Sign Up widget
