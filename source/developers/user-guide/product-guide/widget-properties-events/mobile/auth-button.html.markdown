...
This widget allows you to handle Authentication to your AC apps. Please see [Authentication for your Apps](/developers/user-guide/product-guide/advanced-features/authentication-for-your-apps/) section for more detail
...
<td width="779">
  Select the <a href="/developers/user-guide/product-guide/widget-properties-events/authentication/authpassword">Password</a> widget.
...
<td width="779">
  This accesses a <a href="/developers/user-guide/product-guide/widget-properties-events/authentication/authcaptcha">Captcha</a> Widget, to prevent computer automatic access. Used when widget is defined as Sign Up widget
