...
<td width="779">
  This is where you can prefill your widget either manually or by importing a CSV list stored as a resource. See <a href="/developers/user-guide/product-guide/widget-properties-events/prefill">Prefill</a>
