...
Search is to allow you to search for data and return the results to other Widgets that are [Listening](/developers/user-guide/product-guide/advanced-features/data-integration-reporting-dashboards/data-section-properties/listen)
