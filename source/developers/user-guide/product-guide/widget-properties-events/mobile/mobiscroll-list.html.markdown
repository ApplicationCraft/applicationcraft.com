...
<td width="779">
This is where you can prefill your list. You can also populate your list by code. See [Mobiscroll List](/developers/user-guide/scripting-apis/client-api/widget-data-state-manipulation/populatewidget/mobiscroll-list2)
