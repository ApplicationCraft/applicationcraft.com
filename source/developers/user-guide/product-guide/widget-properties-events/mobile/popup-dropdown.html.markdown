...
The Popup Dropdown 'pop's up' the list of selections available to users. Users can select a single item.

The Popup Dropdown allows items to be populated in the following ways
...
<td width="779">
Internal class name of the widget.- WiziCore\_UI\_PopupDropdownMobileWidget
...
<td width="779">
  This is where you can prefill your list/dropdown widgets either manually or by importing a CSV list stored as a resource. See <a href="/developers/user-guide/product-guide/widget-properties-events/prefill">Prefill</a>
...
## See Also
 ...
 - Mobile Widgets: [Popup Listbox](/developers/user-guide/product-guide/widget-properties-events/mobile/popup-listbox)

 - Common Widgets: [Dropdown List](/developers/user-guide/product-guide/widget-properties-events/common/dropdown-list) , [Listbox](/developers/user-guide/product-guide/widget-properties-events/common/listbox)
