...
Mobiscroll Date is a scroller style date/time picker optimized for touch devices such as iPhone, iPad, Android, to easily enter date and/or time
...
<td width="779">
Internal class name of the widget.- Mobiscroll
...
<td width="779">
true/false 12/24 hour format on timepicker
...
<td width="779">
Set how many years to show in widget
...
<td width="779">
current/current +1/current -1, mid of years to show. Where you can set the default year
