...
There are two ways to specify the transition effects
 ...
 - pageXxxx() API functions - this gives you a higher level of control and allows you to call functions like [pageNext()](../../scripting-apis/client-api/page-functions/pagenext.htm) where you can specify a) the effect and b) the direction of the effect (forwards or backwards). Please note that using 'reverse' transitions can sometimes be slightly slower.
...
## See Also:
 ...
 - [Mobile Transition Mode](mobile_transition_mode.htm)
