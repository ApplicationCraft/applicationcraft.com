...
If you find that you cannot get [Phonegap:Build](phonegapbuild.htm) or [AC Mobile Build](application-craft-build.htm) to behave exactly the way you need it to, then you may want to use PhoneGap itself. This provides you with direct access to the platform compilers so you can fine tune everything.
