...
Please note that for each AC app you wish to use the [Xtify Push Notifications](index) plugin, you will need to create new keys.
...
When completed make a note of the Application Keys to enter into the [Xtify Push Notifications](index) properties.
