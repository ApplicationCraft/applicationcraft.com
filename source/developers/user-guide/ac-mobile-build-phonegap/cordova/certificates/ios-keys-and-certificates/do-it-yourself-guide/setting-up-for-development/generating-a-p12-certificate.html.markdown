...
You will need to generate a P12 Certificate which needs to be provided to the [AC Mobile Build](../../../../ac-mobile-build/index.htm) Platform or to [Phonegap:Build](../../../../phonegapbuild/index.htm) . The screenshot below shows where this certificate should be used.
...
The P12 certificate is now ready for upload into either your [AC Mobile Build](../../../../ac-mobile-build/index.htm) screen (shown at the very top of this page) or into Phonegap Build.
