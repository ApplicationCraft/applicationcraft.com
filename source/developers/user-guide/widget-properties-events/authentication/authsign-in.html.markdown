...
The Sign In Widget will be used by anyone accessing your App. Most Apps require a Sign In to verify the users are properly authenticated.
...
<td width="779">
Internal class name of the widget.- WiziCore\_UI\_SignInButtonWidget
...
<td width="779">
Select the checkbox widget users can check to be remembered
...
See Also:
 ...
 - [Sign In](../../product-guide/advanced-features/authentication-for-your-apps/sign-in.htm)
