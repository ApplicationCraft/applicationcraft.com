...
The action button can be used to manage Data views and Page Navigation, but also can be used to trigger [Events](../events/index.htm) using [Scripting with Javascript](../../scripting-apis/client-scripting-overview/scripting-with-javascript/index.htm)
...
See Also:
 ...
 - Common Widgets: [Action Button](../common/action-button.htm) , [Fancy Button](../common/fancy-button.htm)
