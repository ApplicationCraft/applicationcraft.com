...
<td width="779">
This is where you can prefill your widget either manually or by importing a CSV list stored as a resource. See [Prefill](../prefill.htm)
...
## See Also:
 ...
 - [Mobile Navigation Toolbar](../../product-guide/advanced-important-widgets/important-mobile-widgets/mobile-navigation-toolbar.htm)
