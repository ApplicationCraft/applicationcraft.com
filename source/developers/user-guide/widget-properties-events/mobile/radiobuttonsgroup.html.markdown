...
## See Also:
 ...
 - Mobile Widgets: [Checkbox Group](checkbox_group.htm) , [Flip Toggle Switch](flip_toggle_switch.htm)

 - Common Widgets: [Radio Button](../common/radio-button.htm) , [Checkbox](../common/checkbox.htm)
