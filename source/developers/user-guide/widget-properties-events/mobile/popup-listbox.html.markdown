...
The Popup Listbox 'pop's up' the list of selections available to users. Users can select multiple items
...
<td width="779">
Set the label of the widget to show on the app
...
## See Also:
 ...
 - Mobile Widgets: [Popup Dropdown](popup_dropdown.htm)

 - Common Widgets: [Listbox](../common/listbox.htm) , [Dropdown List](../common/dropdown-list.htm)
