...
Allows users to toggle On/Off. You can then interact with this change if required using [Scripting with Javascript](../../scripting-apis/client-scripting-overview/scripting-with-javascript/index.htm)
