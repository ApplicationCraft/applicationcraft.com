...
This allows entry of numeric data with basic format control. If you need to enter data in a specific way, you can use a [Mask Edit](../advanced/mask-edit) control. Alternatively, you could use a "Regular Expression" in Application Craft Javascript to achieve complex data format validations post entry.
...
## See Also:
 ...
 - Common Widgets: [Text Area](text-area.htm) , [Text](text.htm) , [Alpha Numeric](alpha-numeric.htm)
