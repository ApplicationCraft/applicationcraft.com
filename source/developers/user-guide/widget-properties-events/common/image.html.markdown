...
The Image displays an Image that is stored within the [Resources](../../product-guide/the-console/console-tabs/resources.htm) area. You can load an image from an external data source using the Data section properties, set up [Image Mapping](../../product-guide/advanced-important-widgets/image-maps-and-emoticons/image-maps.htm) to allow your users to select area(s) in your image or bind your images to [Slider](../advanced/sliders.htm) widgets to create emoticons
...
See Also:
 ...
 - [Image Maps and Emoticons](../../product-guide/advanced-important-widgets/image-maps-and-emoticons/index.htm)

 - [Sliders](../advanced/sliders.htm#general)
