...
The QR Code widget allows you to show this within your App. Users can scan this (with their mobile devices usually) to be able to load the app defined in  the widget.  The QR Code for your app is also shown on the [Apps](../../product-guide/the-console/console-tabs/applications.htm) Console tab
