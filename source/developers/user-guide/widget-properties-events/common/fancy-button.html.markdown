...
The Fancy Button allows you to define shapes, gradient colors when pressed, as well as be used to manage Data views and Page Navigation, but also can be used to trigger [Events](../events/index.htm) using [Scripting with Javascript](../../scripting-apis/client-scripting-overview/scripting-with-javascript/index.htm)
...
See Also:
 ...
 - Mobile Widgets: [Action Button](../mobile/mobaction-button.htm)

 - Common Widgets: [Action Button](action_button.htm)
