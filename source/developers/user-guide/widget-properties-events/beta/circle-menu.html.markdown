...
<td width="782">
This is where you can prefill your list/dropdown widgets either manually or by importing a CSV list stored as a resource. See [Prefill](../prefill.htm) . The top entry is where you can enter text to show in the main item
...
## See Also:
 ...
 - [Circular Menu Widget](../../product-guide/advanced-important-widgets/circle-menu-widget/index.htm)
