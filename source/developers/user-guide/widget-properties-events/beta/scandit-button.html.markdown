...
This widget allows you to scan barcodes and other codes in your Native Apps using the [Scandit](http://www.scandit.com/) barcode scanner and the [Scandit Free](../../ac-mobile-build-phonegap/cordova/ac-mobile-build/ac-build-plugins/scandit-free.htm) plugin.
...
## See Also:
 ...
 - [Scandit Widget](../../product-guide/advanced-important-widgets/scandit-widget/index.htm)
